                    ...
                    >
                        <div>
                            <div className="container">
                                <div><h4>Proyecto: {this.state.projectTitle}</h4></div>
                                <br />
                                <div><h3>Ubicación: {this.state.selectedProjectLocation}</h3></div>
                ...
                >
                    <div className="Modal">
                        <div id="heading-modal">
                            <button className="hollow button" id="close-button" onClick={this.closeModal}><img id="proj-icon" src={close}></img></button>
                            <div><h4>Proyecto: {this.state.projectTitle}</h4></div>
                            <br />
                            <div><h3>Ubicación: {this.state.selectedProjectLocation}</h3></div>
