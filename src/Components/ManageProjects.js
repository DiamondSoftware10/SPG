...
class ManageProjects extends Component {
  ...
  ModifyProject(){
    ...
    render() {
      ...
      return(
        <div>   
          <div id="div-table" style={{display: 'flex', justifyContent: 'center' ,width: '100%' , padding: '2em'  }}>
            <ReactTable 
                          ...
                          return {
                            onClick: (e) => {
                              this.setState(
                                ...
                                selectedDescripcion: this.state.data[rowInfo.index].descripcion,
          ...
          >
              ...
              <button className= "btn-secondary" onClick={() => this.DeleteUser(this.state.selectedID)}><FaRegFrownOpen/> Desactivar</button>
              <button className= "btn-secondary" onClick={() => this.UndoDelete(this.state.selectedID)}><FaRegGrin/> Reactivar</button>             
              <button className= "btn-secondary" onClick={() => {this.openForm() }}><FaEdit/> Editar</button>

              <div  style={{ justifyContent: 'center' ,width: '100%' , padding: '2em'  }} hidden = {this.state.formIsHidden}>
